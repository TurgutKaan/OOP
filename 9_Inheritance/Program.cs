...
class Program
{
    static void Main()
    {
        ...
        //   eft.IslemTarihi = DateTime.Now; // Not : İşlem tarihi instance alındığında set edilsin. Sınıf dışında tarih set edilmesin. Çünkü bizim sistemiz henüz tarih belirlenerek ödeme işleme yapamamamktadır.
        eft.Tutar = 150;
